...
public class PageView extends TextView {
    ...
    private void initView(Context context) {
        mViewWidth = UiUtils.getScreenWidthPixels(context);
        mViewHeight = UiUtils.getScreenHeightPixels(context);
    ...
    private void createDrawable() {
        ...
        mFrontShadowColors = new int[]{0x80e0e0e0, 0x111111};
...
/*    @Override
    ...
    public void calcCornerXY(float x, float y) {
        if (x <= mViewWidth / 2) mCornerX = 0;
        else mCornerX = mViewWidth;
    ...
    public void setViewSize(int mViewWidth, int mViewHeight) {
